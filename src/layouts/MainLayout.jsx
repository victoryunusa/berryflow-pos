  ...
  return (
    <div className="flex gap-0 font-manrope bg-white text-gray-500 font-semibold overflow-x-0">
      ...
      <main className="w-full flex-1 bg-gray-100 mx-auto overflow-x-hidden overflow-y-scroll min-h-screen">
        <header className="flex flex-row justify-start items-center bg-white w-full px-12 py-5">
          <div className="w-1/5">
          ...
          <div className="w-4/5 flex flex-row justify-end items-center space-x-5">
            ...
            <button
              ...
              className="bg-orange-200 p-2 rounded-lg hover:cursor-pointer"
            >
              <span>
                <svg
                  width="24"
            ...
            <div className="relative z-50">
              ...
              >
                <Avatar
                  label={user && user?.first_name?.charAt(0)}
                  className="h-10 w-10 font-manrope text-gray-700 text-xl font-bold rounded-lg"
                />
              ...
              {isOpenProfile === true ? (
                <div className="absolute top-12 right-3 z-50 transition ease-in duration-700">
                  <div className="w-64 rounded-lg shadow-md my-2 pin-t pin-l bg-white border">
                    <ul className="list-reset overflow-y-scroll p-2">
                      <li
                        onClick={() => setIsOpenProfile(!isOpenProfile)}
        ...
        <div className="md:p-10 p-3 flex flex-row gap-10">
