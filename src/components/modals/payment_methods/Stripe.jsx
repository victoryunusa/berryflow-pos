...
const Stripe = ({ setOpen }) => {
  ...
  const validationSchema = Yup.object().shape({
    public_key: Yup.string().required("Public key name is required!"),
    ...
    try {
      ...
      dispatch(
        alertActions.success({
          message: "Stripe setup was successful.",
    ...
    return createPortal(
      <>
        <div className="fixed inset-0 z-[999] overflow-y-auto">
          ...
          <div className="flex items-center min-h-screen px-2 py-2 translate-y-[-50px] transition-all duration-300 ease-in-out">
            <div className="relative w-full max-w-md p-6 md:p-6 mx-auto bg-white rounded-md shadow-lg">
